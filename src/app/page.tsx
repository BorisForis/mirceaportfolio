    ...
    <main className="flex min-h-screen flex-col items-start justify-between">
      ...
      <div className="flex flex-col items-center justify-center w-screen h-96">
        ...
        <div className="absolute flex flex-col justify-center items-center w-4/6 h-4/6"> 
          <h1 className="flex flex-row z-10 text-2xl text-white pt-10 xl:text-6xl">Welcome to Mircea's
              <span className="text-red-600 text-2xl font-bold p-1 xl:text-6xl">Portfolio</span> 
          </h1>
          <p className="z-10 text-md text-gray-100 p-12 xl:text-4xl"> Hello, I am Mircea, a full-stack developer driven by a fervent passion for crafting clean, 
          ...
          <p className="z-10 text-md text-gray-100 p-12 xl:text-4xl">
