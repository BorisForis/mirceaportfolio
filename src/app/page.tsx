  ...
  return (
    <main className="flex min-h-screen flex-col items-start justify-between">
      ...
      <div className="flex flex-col items-center justify-center w-screen h-auto">
        <img src="/programing.png" alt="programing" className="absolute z-0 w-screen h-5/6 xl:h-3/4 py-5 px-12 opacity-70 blur-md"/>
        <div className="flex flex-col justify-center items-center w-4/6 h-4/6"> 
          <h1 className="flex flex-row z-10 text-2xl text-white pt-10 xl:text-4xl">Welcome to Mircea's</h1>
          <span className="text-red-600 text-2xl z-10 font-bold p-1 xl:text-4xl">Portfolio</span> 
          <p className="z-10 text-md text-gray-100 p-5 xl:p-12 xl:text-2xl"> Hello, I am Mircea, a full-stack developer driven by a fervent passion for crafting clean, 
          ...
          <p className="z-10 text-md text-gray-100 p-5 xl:p-12 xl:text-2xl">
